...
class BufferedEvent {
  ...
  constructor(public data: any, public encoding?: string, public cb?: Function) {
    ...
    if (typeof(this.data) !== 'string') {
      // Use sliceCopy extension if available, otherwise fallback to Buffer.concat
      this.data = (
        typeof this.data.sliceCopy !== 'undefined' ?
          this.data.sliceCopy() :
 ...
 */
export class AbstractDuplexStream extends events.EventEmitter implements NodeJS.ReadWriteStream {
  /**
